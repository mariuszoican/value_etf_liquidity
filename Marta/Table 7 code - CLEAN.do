...
outreg2 using "U:\kpz_etfliquidity\data_Marta\output\highfee_determinants.tex", adjr2 replace tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets_std lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks different_lead_mm ratio_tii_std, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "U:\kpz_etfliquidity\data_Marta\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_diffbench marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets_std lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks different_lead_mm ratio_tii_std, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "U:\kpz_etfliquidity\data_Marta\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_majorindex marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets_std lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks  different_lead_mm ratio_tii_std, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "U:\kpz_etfliquidity\data_Marta\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_diffleadmm marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets_std lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks  different_lead_mm ratio_tii_std, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "U:\kpz_etfliquidity\data_Marta\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)
