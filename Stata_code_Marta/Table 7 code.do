/// Table 7 - First-mover advantage: Linear probability model
// -------------------------------------
...
reghdfe highfee firstmover, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants.tex", adjr2 replace tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_diffbench marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_majorindex marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks  different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)



reghdfe highfee firstmover firstmover_diffleadmm marketing_fee_bps_std other_expense_std fee_waiver_std stock_tweets lend_byaum_bps_std tr_error_bps_std creation_fee_std perf_drag_bps_std different_benchmarks  different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)
...
reghdfe highfee firstmover, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants2.tex", adjr2 replace tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover marketing_fee_bps other_expenses fee_waivers stock_tweets lend_byaum_bps tr_error_bps creation_fee perf_drag_bps different_benchmarks different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants2.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_diffbench marketing_fee_bps other_expenses fee_waivers stock_tweets lend_byaum_bps tr_error_bps creation_fee perf_drag_bps different_benchmarks different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants2.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_majorindex marketing_fee_bps other_expenses fee_waivers stock_tweets lend_byaum_bps tr_error_bps creation_fee perf_drag_bps different_benchmarks  different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants2.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)

reghdfe highfee firstmover firstmover_diffleadmm marketing_fee_bps other_expenses fee_waivers stock_tweets lend_byaum_bps tr_error_bps creation_fee perf_drag_bps different_benchmarks  different_lead_mm ratio_tii, absorb(index_id quarter) vce(cl index quarter)
outreg2 using "`directory'\output\highfee_determinants2.tex", adjr2 append tex tstat label  dec(2) tdec(2) eqdrop(/) keep(*)
