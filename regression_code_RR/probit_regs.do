...
outreg2 using "`directory'\output\RR_RFS\probit.tex", replace tex tstat e(r2_p)  label  dec(2) tdec(2) eqdrop(/) keep(*) 

probit competition log_aum top3_issuer major_brand_index, vce(robust)
outreg2 using "`directory'\output\RR_RFS\probit.tex", append tex tstat e(r2_p)  label  dec(2) tdec(2) eqdrop(/) keep(*)
