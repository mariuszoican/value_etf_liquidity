...
import delimited "`directory'data\etf_panel_merged.csv"
...
label variable perf_drag_avg "Performance drag"
...
reghdfe mer_bps spread_bps_crsp tr_error_bps perf_drag_avg d_uit lend_byaum_bps marketing_fee_bps, absorb(index yearmonth) vce(cluster index yearmonth)
...
reghdfe mer_bps logdvol tr_error_bps perf_drag_avg d_uit lend_byaum_bps marketing_fee_bps, absorb(index yearmonth) vce(cluster index yearmonth)
...
reghdfe mer_bps turnover_frac tr_error_bps perf_drag_avg d_uit lend_byaum_bps marketing_fee_bps, absorb(index yearmonth) vce(cluster index yearmonth)
...
reghdfe mer_bps mkt_share tr_error_bps perf_drag_avg d_uit lend_byaum_bps marketing_fee_bps, absorb(index yearmonth) vce(cluster index yearmonth)
