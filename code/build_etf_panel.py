...
if __name__ == "__main__":
    ...
    cs_panel=etf_graph_for_cs.groupby('ticker')[['lend_byAUM_bps','mer_bps','spread_bps_crsp','volume','tr_error_bps','perf_drag_bps','turnover_frac',
                            'd_UIT','mkt_share','marketing_fee_bps','aum','aum_index','highfee','other_expenses','fee_waivers','net_expense_mer','mgr_duration','mgr_duration_tii','mgr_duration_tsi','ratio_tra','ratio_tii','stock_tweets','effectivespread_dollar_ave',
       'effectivespread_percent_ave', 'effectivespread_dollar_dw',
       'effectivespread_dollar_sw', 'effectivespread_percent_dw',
       'effectivespread_percent_sw', 'dollarrealizedspread_lr_ave',
       'percentrealizedspread_lr_ave', 'dollarrealizedspread_lr_sw',
